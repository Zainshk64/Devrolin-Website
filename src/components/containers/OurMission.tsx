          ...
          <div className="col-12 col-lg-5 col-xxl-5">
            <div className="section__header text-center text-lg-start mb-0">
              ...
              <h2 className="title title-anim">
                Built On Systems. Driven By Results.
              </h2>
            </div>
          </div>
            ...
            <div className="mission-s__single mission-s__single--alt fade-top">
              ...
              <div className="section__content-cta">
                <p className="primary-text">
                  We focus on outcomes not complexity. Every system is designed
                  to automate operations, integrate seamlessly with your tools,
                  and deliver measurable results without unnecessary overhead.
                </p>
              </div>
            </div>
          </div>
